...
Init()
    ...
    readonly SCRIPT_VERSION=200605
    debug=false
    ResetErrorcode
    ...
    SHERPA_QPKG_NAME+=(SABnzbdplus)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/SABnzbdplus/build/SABnzbdplus_200523.qpkg)
        SHERPA_QPKG_MD5+=(8f7a5801e5e25e1ef9e03f320a08c9eb)
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/SABnzbd/build/SABnzbd_200605.qpkg)
        SHERPA_QPKG_MD5+=(690ef19b9cec9ba225c21d913e33b515)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/LazyLibrarian/build/LazyLibrarian_200605.qpkg)
        SHERPA_QPKG_MD5+=(42ed4ea12662e1421390ec7866a9f27a)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/OMedusa/build/OMedusa_200605.qpkg)
        SHERPA_QPKG_MD5+=(17f64fb226b817deb5f80098a36483a4)
    ...
    SHERPA_QPKG_NAME+=(Headphones)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/Headphones/build/Headphones_200605.qpkg)
        SHERPA_QPKG_MD5+=(85f17a8b49b55a8d0ee56cd1cff1c848)
