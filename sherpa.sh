...
Init()
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/nzbToMedia/build/nzbToMedia_200814.qpkg)
        SHERPA_QPKG_MD5+=(df5247c585699e765c33836187e305b7)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/SickChill/build/SickChill_200814.qpkg)
        SHERPA_QPKG_MD5+=(28f3ad5d5a079b3afbf063653018b2e8)
    ...
    SHERPA_QPKG_NAME+=(OWatcher3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/OWatcher3/build/OWatcher3_200814.qpkg)
        SHERPA_QPKG_MD5+=(6c140aa9d288f4cbd3dfac1c0aec2869)
