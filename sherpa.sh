...
Init()
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(noarch)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/SickChill/build/SickChill_181011.qpkg)
    ...
    SHERPA_QPKG_NAME+=(CouchPotato2)
        ...
        SHERPA_QPKG_MD5+=(ce55e42401b3be40e35e96f0fe30b13a)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(noarch)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/LazyLibrarian/build/LazyLibrarian_181112.qpkg)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(noarch)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/OMedusa/build/OMedusa_180427.qpkg)
    ...
    SHERPA_QPKG_NAME+=(Headphones)
        SHERPA_QPKG_ARCH+=(noarch)
        SHERPA_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/sherpa/master/QPKGs/Headphones/build/Headphones_190915.qpkg)
        SHERPA_QPKG_MD5+=(7f43235069e2a79663dec9ecf2f9804b)
    ...
    SHERPA_QPKG_NAME+=(NZBGet)
        ...
        SHERPA_QPKG_MD5+=(effde087e0750dcf063f4662816736fd)
