...
# gpt-engineer.sh
#
# Copyright (C) 2024 OneCD - one.cd.only@gmail.com
#
...
Init()
	...
	readonly SCRIPT_VERSION=240105
	...
	readonly DAEMON_PATHFILE=$VENV_PATH/bin/gpte
	readonly DAEMON_LAUNCH_CMD="$VENV_PYTHON_PATHFILE $DAEMON_PATHFILE"
	...
	readonly GET_UI_PORT_CMD='echo 0'
