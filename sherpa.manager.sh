...
Session.Init()
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/SABnzbd/build/SABnzbd_201129.qpkg)
        SHERPA_QPKG_MD5+=(01136a53c908b49e502bc4404b9e7a1c)
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/nzbToMedia/build/nzbToMedia_201129.qpkg)
        SHERPA_QPKG_MD5+=(b19b2be7fca49526b87ac2a4a4f12c0f)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/LazyLibrarian/build/LazyLibrarian_201129.qpkg)
        SHERPA_QPKG_MD5+=(ceadb2b69bca6692f3335b1baadd59f3)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/OMedusa/build/OMedusa_201129.qpkg)
        SHERPA_QPKG_MD5+=(fd27124087f4e0c725a8e5bc49f8adde)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/OSickGear/build/OSickGear_201129.qpkg)
        SHERPA_QPKG_MD5+=(3723407e15e334265d764532d4c1c132)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/Mylar3/build/Mylar3_201129.qpkg)
        SHERPA_QPKG_MD5+=(7db9b00980552de767d4285cb4e035f5)
