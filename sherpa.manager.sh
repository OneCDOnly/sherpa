...
Session.Init()
    ...
    MANAGER_QPKG_NAME+=(SABnzbd)
        ...
        MANAGER_QPKG_IPKGS_REMOVE+=('')
        MANAGER_QPKG_PIPS_ADD+=('babelfish chardet cheetah3 cheroot cherrypy configobj feedparser guessit importlib-resources jaraco.classes jaraco.collections jaraco.context jaraco.functools jaraco.text more_itertools portend puremagic python-dateutil rebulk sabyenc3 sgmllib3k tempora zc.lockfile')
        MANAGER_QPKG_SUPPORTS_BACKUP+=(true)
        MANAGER_QPKG_RESTART_TO_UPDATE+=(true)
    ...
    MANAGER_QPKG_NAME+=($PROJECT_NAME)
        ...
        MANAGER_QPKG_MD5+=(bea58a827553e39c5da5f8c78f9f4a54)
    ...
    MANAGER_QPKG_NAME+=(SortMyQPKGs)
        MANAGER_QPKG_ARCH+=(all)
        MANAGER_QPKG_MIN_RAM_KB+=(any)
        MANAGER_QPKG_VERSION+=(211207)
        MANAGER_QPKG_URL+=(https://raw.githubusercontent.com/OneCDOnly/${MANAGER_QPKG_NAME[${#MANAGER_QPKG_NAME[@]}-1]}/main/build/${MANAGER_QPKG_NAME[${#MANAGER_QPKG_NAME[@]}-1]}_${MANAGER_QPKG_VERSION[${#MANAGER_QPKG_VERSION[@]}-1]}.qpkg)
        MANAGER_QPKG_MD5+=(847f2bd7f3583676de6f431bbb657bf9)
