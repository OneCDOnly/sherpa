...
QPKG.Enable()
    ...
    [[ $resultcode -ne 0 ]] && ShowAsWarn "unable to enable $(FormatAsPackageName "$1") $(FormatAsExitcode $resultcode)"
...
QPKG.Disable()
    ...
    [[ $resultcode -ne 0 ]] && ShowAsWarn "unable to disable $(FormatAsPackageName "$1") $(FormatAsExitcode $resultcode)"
