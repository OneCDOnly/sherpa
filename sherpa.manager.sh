...
Session.Init()
    ...
    local -r SCRIPT_VERSION=220419d
...
PIPs.DoInstall()
    ...
    if (Opts.Deps.Check.IsSet && QPKGs.IsInstalled.Exist SABnzbd) || QPKGs.OpToInstall.Exist SABnzbd || QPKGs.OpToReinstall.Exist SABnzbd || QPKGs.OpOkInstall.Exist Entware; then
