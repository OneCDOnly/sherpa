...
Session.Init()
    ...
    MANAGER_QPKG_NAME+=(duf)
        ...
        MANAGER_QPKG_MD5+=(f80deb3c9c35b3498fa211a1cd3e1a12)
    ...
    MANAGER_QPKG_NAME+=(duf)
        ...
        MANAGER_QPKG_MD5+=(877f0ce73faddbb335983534972d0bcc)
        MANAGER_QPKG_DESC+=('a nice CLI disk-usage/free-space utility from @muesli')
        MANAGER_QPKG_ABBRVS+=('duf')
        MANAGER_QPKG_ESSENTIALS+=('')
        MANAGER_QPKG_IPKGS_ADD+=('')
    ...
    MANAGER_QPKG_NAME+=(duf)
        ...
        MANAGER_QPKG_MD5+=(4fc2f45ed8031bc44871b005759dbf74)
        MANAGER_QPKG_DESC+=('a nice CLI disk-usage/free-space utility from @muesli')
        MANAGER_QPKG_ABBRVS+=('duf')
        MANAGER_QPKG_ESSENTIALS+=('')
        MANAGER_QPKG_IPKGS_ADD+=('')
    ...
    MANAGER_QPKG_NAME+=(duf)
        ...
        MANAGER_QPKG_MD5+=(2a097d95f9deae7a390ffc91f595aefb)
        MANAGER_QPKG_DESC+=('a nice CLI disk-usage/free-space utility from @muesli')
        MANAGER_QPKG_ABBRVS+=('duf')
        MANAGER_QPKG_ESSENTIALS+=('')
        MANAGER_QPKG_IPKGS_ADD+=('')
