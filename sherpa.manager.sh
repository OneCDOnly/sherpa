...
Session.Init()
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/SABnzbd/build/SABnzbd_201129b.qpkg)
        SHERPA_QPKG_MD5+=(ed59857f7f6e057f15bb7d6cb2eb559c)
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/nzbToMedia/build/nzbToMedia_201129b.qpkg)
        SHERPA_QPKG_MD5+=(09848c989a301d36838c1190fa323805)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/SickChill/build/SickChill_201129b.qpkg)
        SHERPA_QPKG_MD5+=(100febefb06a036eb4835c1e3dbbd4b7)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/LazyLibrarian/build/LazyLibrarian_201129b.qpkg)
        SHERPA_QPKG_MD5+=(a698d4ee57a0a4e54bd6506d5d9d2a5d)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/OMedusa/build/OMedusa_201129b.qpkg)
        SHERPA_QPKG_MD5+=(d692137ae35026d69f2d6d62230abef9)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/OSickGear/build/OSickGear_201129b.qpkg)
        SHERPA_QPKG_MD5+=(c02f8b962f1307df636bb0c05fc52975)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/Mylar3/build/Mylar3_201129b.qpkg)
        SHERPA_QPKG_MD5+=(fea7f6e9d2aaf1b38ef4e65588f1ab7c)
    ...
    SHERPA_QPKG_NAME+=(NZBGet)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/NZBGet/build/NZBGet_201129.qpkg)
        SHERPA_QPKG_MD5+=(0a07aa907d5862cd1012d158b13f7068)
    ...
    SHERPA_QPKG_NAME+=(OTransmission)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/OTransmission/build/OTransmission_201129.qpkg)
        SHERPA_QPKG_MD5+=(768e8614e47476954ea16d6ce59ef2d0)
    ...
    SHERPA_QPKG_NAME+=(Deluge-server)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/Deluge-server/build/Deluge-server_201129.qpkg)
        SHERPA_QPKG_MD5+=(84a5cd7957c0d23f8fbdc5c322c18be5)
    ...
    SHERPA_QPKG_NAME+=(Deluge-web)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=("$PROJECT_REPO_URL"/Deluge-web/build/Deluge-web_201129.qpkg)
        SHERPA_QPKG_MD5+=(2f2312198aa9ddc62b1d24d6d7bb7ee3)
