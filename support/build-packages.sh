...
cdn_sherpa_url_msg='https://raw.githubusercontent.com/OneCDOnly/sherpa/main/QPKGs/<?package_name?>/build'
cdn_other_url_msg='https://raw.githubusercontent.com/OneCDOnly/<?package_name?>/main/build'
...
buffer=$(sed "s|<?cdn_sherpa_url?>|$cdn_sherpa_url_msg|" <<< "$buffer")
buffer=$(sed "s|<?cdn_other_url?>|$cdn_other_url_msg|" <<< "$buffer")
