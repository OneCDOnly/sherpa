...
# sorted
r_qpkg_is_states=(active backedup complete downloaded enabled installable installed missing signed upgradable)
r_qpkg_isnt_states=(active backedup complete downloaded enabled installable installed missing signed upgradable)
