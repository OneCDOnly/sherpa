...
Init()
	...
	readonly GET_UI_PORT_SECURE_ENABLED_TEST_CMD='[[ $(/sbin/getcfg General https_enabled -d 0 -f '$QPKG_INI_PATHFILE') = 1 ]]'
	readonly GET_UI_LISTENING_ADDRESS_CMD='/sbin/getcfg General http_host -d undefined -f '$QPKG_INI_PATHFILE
