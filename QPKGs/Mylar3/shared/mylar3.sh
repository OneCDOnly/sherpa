...
Init()
    ...
    readonly SECURE_PORT_ENABLED_CMD="/sbin/getcfg interface enable_https -d 0 -f $QPKG_INI_PATHFILE"
    readonly UI_LISTENING_ADDRESS_CMD="/sbin/getcfg interface http_host -d '0.0.0.0' -f $QPKG_INI_PATHFILE"
    ui_port=0
    ui_port_secure=0
