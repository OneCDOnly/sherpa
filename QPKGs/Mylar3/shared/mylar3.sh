...
InstallAddons()
    ...
    if IsNotVirtualEnvironmentExist; then
        ExecuteAndLog 'create new virtual Python environment' "export PIP_CACHE_DIR=$PIP_CACHE_PATH VIRTUALENV_OVERRIDE_APP_DATA=$PIP_CACHE_PATH; $INTERPRETER -m virtualenv $VENV_PATH --system-site-packages" log:everything || SetError
        new_env=true
    fi
