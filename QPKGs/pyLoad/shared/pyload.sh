...
Init()
	...
	readonly UI_PORT_SECURE_CMD="GetPyloadConfig $QPKG_INI_PATHFILE webui port"
	readonly UI_PORT_SECURE_ENABLED_TEST_CMD="[[ $(GetPyloadConfig "$QPKG_INI_PATHFILE" webui use_ssl) = True ]]"
	readonly UI_LISTENING_ADDRESS_CMD="GetPyloadConfig $QPKG_INI_PATHFILE webui host"
	daemon_port=0
	ui_port=0
	ui_port_secure=0
