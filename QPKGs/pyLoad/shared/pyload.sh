...
Init()
	...
	readonly VENV_PYTHON_PATHFILE=$VENV_PATH/bin/python
	...
	readonly DAEMON_LAUNCH_CMD="$VENV_PYTHON_PATHFILE $DAEMON_PATHFILE --daemon --userdir $QPKG_PATH/config --pidfile $DAEMON_PID_PATHFILE"
