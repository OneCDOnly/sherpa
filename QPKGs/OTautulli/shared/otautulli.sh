...
get_ui_port_cmd="/sbin/getcfg General http_port -d 8181 -f $qpkg_ini_pathfile"
get_ui_port_secure_cmd="/sbin/getcfg General http_port -d 8181 -f $qpkg_ini_pathfile"
