...
Init()
	...
	readonly QPKG_INI_PATHFILE=$QPKG_PATH/config/qBittorrent/config/qBittorrent.conf
	...
	readonly UI_PORT_SECURE_CMD="/sbin/getcfg Preferences 'WebUI\Port' -d 0 -f $QPKG_INI_PATHFILE"
