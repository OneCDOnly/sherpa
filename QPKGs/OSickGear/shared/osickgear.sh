...
Init()
	...
	readonly DAEMON_LAUNCH_CMD=". $VENV_PATH/bin/activate && cd $QPKG_REPO_PATH && $VENV_INTERPRETER $DAEMON_PATHFILE --daemon --nolaunch --datadir $(/usr/bin/dirname "$QPKG_INI_PATHFILE") --pidfile $DAEMON_PID_PATHFILE"
