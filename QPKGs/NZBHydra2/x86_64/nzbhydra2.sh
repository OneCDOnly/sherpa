...
Init()
	...
	readonly GET_UI_PORT_SECURE_ENABLED_TEST_CMD='[[ $(parse_yaml '$QPKG_INI_PATHFILE' | /bin/grep main_ssl= | cut -d\" -f2) = true ]]'
	readonly GET_UI_LISTENING_ADDRESS_CMD='parse_yaml '$QPKG_INI_PATHFILE' | /bin/grep main_host= | cut -d\" -f2'
