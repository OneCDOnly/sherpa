...
Init()
    ...
    local SETTINGS="--userdata $(dirname $SETTINGS_PATHFILE) --conf $SETTINGS_PATHFILE"
    local PIDS="--pid $STORED_PID_PATHFILE"
...
StartQPKG()
    ...
    ui_port=$(/opt/bin/jq -r .Server.serverport < "$SETTINGS_PATHFILE")
