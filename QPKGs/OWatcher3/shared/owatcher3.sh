#!/usr/bin/env bash
#* don't edit this file, it was built/modified programmatically with the `build-qpkgs.sh` script. (source: owatcher3.source)
#* owatcher3.sh
...
readonly SERVICE_SCRIPT_VERSION='231116'
InitBasic()
{
