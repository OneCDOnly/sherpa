...
Init()
	...
	readonly SOURCE_GIT_URL=https://github.com/pymedusa/Medusa.git
	...
	readonly DAEMON_PATHFILE=$QPKG_REPO_PATH/start.py
	...
	readonly APP_VERSION_CMD="/bin/grep '^VERSION =' $APP_VERSION_PATHFILE | /bin/sed 's|^.*\"\(.*\)\"|\1|'"
