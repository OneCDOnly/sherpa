...
# omedusa.sh
#
# Copyright (C) 2018-2022 OneCD [one.cd.only@gmail.com]
#
...
Init()
    ...
    readonly PORT_CHECK_TIMEOUT=120      # Medusa is a little slower to start, so give it more time
...
IsSSLEnabled()
    ...
    [[ $(/sbin/getcfg general enable_https -d 0 -f "$QPKG_INI_PATHFILE") -eq 1 ]]
