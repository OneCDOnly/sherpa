#!/usr/bin/env bash
#* Please don't edit this file directly, it was built/modified programmatically with the 'build-qpkgs.sh' script. (source: 'olidarr.source')
#* olidarr.sh
...
readonly SERVICE_SCRIPT_VERSION='240208'
...
remote_url='https://lidarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&'
