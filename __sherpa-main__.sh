...
Init()
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200830.qpkg)
        SHERPA_QPKG_MD5+=(d6c06309f8dd72732b5e559aa80c1659)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/LazyLibrarian/build/LazyLibrarian_200830.qpkg)
        SHERPA_QPKG_MD5+=(f7453d0e778f4415ed776dbed653583d)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Mylar3/build/Mylar3_200830.qpkg)
        SHERPA_QPKG_MD5+=(a5f8c78345eeb8ff3390f581c93aba35)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200830.qpkg)
        SHERPA_QPKG_MD5+=(004ba9af32ef2193eb03670a2494750d)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OSickGear/build/OSickGear_200830b.qpkg)
        SHERPA_QPKG_MD5+=(7536132fc718d2095dd96697a57c224d)
