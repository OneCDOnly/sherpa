...
Init()
    ...
    readonly SCRIPT_VERSION=200824b
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200824b.qpkg)
        SHERPA_QPKG_MD5+=(c51d0be6d66219c8d46fa13e8ac4fd7d)
