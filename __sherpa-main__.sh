...
Init()
    ...
    readonly SCRIPT_VERSION=200822c
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200822b.qpkg)
        SHERPA_QPKG_MD5+=(4c9d2611a2c22002fd974c20eb739ce6)
