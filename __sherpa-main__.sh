...
Init()
    ...
    readonly SCRIPT_VERSION=200825b
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200825.qpkg)
        SHERPA_QPKG_MD5+=(499cc823fc93b6b874320c57ed594ff6)
