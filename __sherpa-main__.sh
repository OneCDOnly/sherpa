...
Init()
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200905.qpkg)
        SHERPA_QPKG_MD5+=(2c51a4025fd3b3e6ee7ee15abc9790ad)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200905.qpkg)
        SHERPA_QPKG_MD5+=(1e3b8b094ddba75484a6f2fb425afa9b)
