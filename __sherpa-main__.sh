...
Init()
    ...
    readonly SCRIPT_VERSION=200823r
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200823b.qpkg)
        SHERPA_QPKG_MD5+=(061d62a40c4068ed273cbbe638f70159)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200823b.qpkg)
        SHERPA_QPKG_MD5+=(1ded08a85e3fbe8b17223a1ff449cf95)
