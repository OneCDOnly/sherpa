...
Init()
    ...
    readonly SCRIPT_VERSION=200825c
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200825.qpkg)
        SHERPA_QPKG_MD5+=(eda8cc49181b572ec656d80b42b90124)
