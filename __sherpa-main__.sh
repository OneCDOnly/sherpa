...
Init()
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200830.qpkg)
        SHERPA_QPKG_MD5+=(e7c5cf75a3fb7c8dc9f7a9c53867463c)
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/nzbToMedia/build/nzbToMedia_200830.qpkg)
        SHERPA_QPKG_MD5+=(f352b1af61a14dae04c348d3f95a28ff)
