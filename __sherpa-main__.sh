...
Init()
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200831c.qpkg)
        SHERPA_QPKG_MD5+=(32fb441a51bb99f06efe6f37912dd6df)
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/nzbToMedia/build/nzbToMedia_200831b.qpkg)
        SHERPA_QPKG_MD5+=(f5e5370e94b41bdc147585a4d9292a4a)
    ...
    SHERPA_QPKG_NAME+=(NZBGet)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/NZBGet/build/NZBGet_200901.qpkg)
        SHERPA_QPKG_MD5+=(58380bd8fbba7d7167339686d0a2308c)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200831.qpkg)
        SHERPA_QPKG_MD5+=(eb41b5c26868011fe7e576e62612483f)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/LazyLibrarian/build/LazyLibrarian_200831.qpkg)
        SHERPA_QPKG_MD5+=(0734c25b25bec72365b0fe1822a996fe)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Mylar3/build/Mylar3_200831.qpkg)
        SHERPA_QPKG_MD5+=(c1e38b8e84d8866e4d42b6657d696c5c)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200831.qpkg)
        SHERPA_QPKG_MD5+=(a896fe2b206d9b12b5097276dab31e42)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OSickGear/build/OSickGear_200831.qpkg)
        SHERPA_QPKG_MD5+=(f07ac767ad1e02e54cf70099b9901e71)
    ...
    SHERPA_QPKG_NAME+=(OTransmission)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OTransmission/build/OTransmission_200901.qpkg)
        SHERPA_QPKG_MD5+=(fac14839e1f57c5fac2e845f92fd3b03)
