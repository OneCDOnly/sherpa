...
Init()
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/LazyLibrarian/build/LazyLibrarian_200901b.qpkg)
        SHERPA_QPKG_MD5+=(ec5150ecd3b2f29a1f05f21907aba880)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Mylar3/build/Mylar3_200901b.qpkg)
        SHERPA_QPKG_MD5+=(ed1bd6d3e6e9a47e7f29eac1ed679c30)
    ...
    SHERPA_QPKG_NAME+=(OTransmission)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OTransmission/build/OTransmission_200901b.qpkg)
        SHERPA_QPKG_MD5+=(94377396559ad9da11453f20254da06d)
    ...
    SHERPA_QPKG_NAME+=(Deluge-server)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Deluge-server/build/Deluge-server_200902.qpkg)
    ...
    SHERPA_QPKG_NAME+=(Deluge-web)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Deluge-web/build/Deluge-web_200902.qpkg)
        SHERPA_QPKG_MD5+=(d4c11c0410b8fa0459bcc7fcbdb0b67b)
