...
Init()
    ...
    readonly SCRIPT_VERSION=200824f
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200824c.qpkg)
        SHERPA_QPKG_MD5+=(44c2aa83e562b011ec9867cd92a95d9e)
    ...
    SHERPA_QPKG_NAME+=(nzbToMedia)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/nzbToMedia/build/nzbToMedia_200824.qpkg)
        SHERPA_QPKG_MD5+=(70f91847b42d37f51e829a8f155207df)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200824.qpkg)
        SHERPA_QPKG_MD5+=(576053e2195c6dd598b3abeead30a375)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200823b.qpkg)
        SHERPA_QPKG_MD5+=(5a611d94e9591500c6477bb643199af9)
