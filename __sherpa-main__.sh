...
Init()
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200901.qpkg)
        SHERPA_QPKG_MD5+=(4fe133f1d08ba8d1fe953e604f0e0b20)
    ...
    SHERPA_QPKG_NAME+=(SickChill)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SickChill/build/SickChill_200901.qpkg)
        SHERPA_QPKG_MD5+=(a7fafa1d74a1f72a1d80b2f4de79ed64)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/LazyLibrarian/build/LazyLibrarian_200901.qpkg)
        SHERPA_QPKG_MD5+=(231e07d387fa4b78dae8df1b724775dd)
    ...
    SHERPA_QPKG_NAME+=(Mylar3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Mylar3/build/Mylar3_200901.qpkg)
        SHERPA_QPKG_MD5+=(e0d850f3c663493dba97f58b8da1df82)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200901.qpkg)
        SHERPA_QPKG_MD5+=(e7dbe9862c769171afd44156f1926400)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OSickGear/build/OSickGear_200901.qpkg)
        SHERPA_QPKG_MD5+=(9c3e6b31e752ed54370fe8f1c8c1de46)
