...
Init()
    ...
    readonly SCRIPT_VERSION=200822d
    ...
    SHERPA_QPKG_NAME+=(SABnzbd)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/SABnzbd/build/SABnzbd_200822c.qpkg)
        SHERPA_QPKG_MD5+=(c4854818ef865507ba9bc8864a80d69d)
    ...
    SHERPA_QPKG_NAME+=(NZBGet)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/NZBGet/build/NZBGet_200820.qpkg)
        SHERPA_QPKG_MD5+=(a60119cbdc5ffeb90b7fa3a88d647868)
    ...
    SHERPA_QPKG_NAME+=(LazyLibrarian)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/LazyLibrarian/build/LazyLibrarian_200820.qpkg)
        SHERPA_QPKG_MD5+=(811ed06ea3068ba03258f5a2fe532799)
    ...
    SHERPA_QPKG_NAME+=(OMedusa)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OMedusa/build/OMedusa_200820c.qpkg)
        SHERPA_QPKG_MD5+=(70cc5aae94c6bc964bc705ea1f37ec19)
    ...
    SHERPA_QPKG_NAME+=(OWatcher3)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OWatcher3/build/OWatcher3_200820.qpkg)
        SHERPA_QPKG_MD5+=(04f2023f6a0c3134943f2e308e397bb1)
    ...
    SHERPA_QPKG_NAME+=(OSickGear)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OSickGear/build/OSickGear_200820.qpkg)
        SHERPA_QPKG_MD5+=(b3f78fce7bb6524bb847f2e32db552e1)
    ...
    SHERPA_QPKG_NAME+=(OTransmission)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/OTransmission/build/OTransmission_200820.qpkg)
        SHERPA_QPKG_MD5+=(0784ed7a83e6989e40313119e715ed14)
