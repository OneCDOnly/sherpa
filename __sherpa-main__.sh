...
Init()
    ...
    SHERPA_QPKG_NAME+=(Deluge-server)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Deluge-server/build/Deluge-server_200903.qpkg)
        SHERPA_QPKG_MD5+=(0f1bd9b2712752414f328f45df4c2fe5)
    ...
    SHERPA_QPKG_NAME+=(Deluge-web)
        SHERPA_QPKG_ARCH+=(all)
        SHERPA_QPKG_URL+=($REMOTE_REPO_URL/QPKGs/Deluge-web/build/Deluge-web_200903.qpkg)
        SHERPA_QPKG_MD5+=(a5db26c17ad7ffe5cbcb2e8ae18142f7)
